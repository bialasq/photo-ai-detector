...
| **P2** | GAP-005 | **Dependency vulnerability scanning** not automated in CI. | `.github/workflows/ci.yml` lint job — no `pip-audit` / `npm audit` | **[3.1.5](../tasks/phase-3/3.1.5-pip-audit-npm-audit-w-ci-warning-only.md)** |
